...
[![Play Video](https://img.shields.io/badge/▶%20Play-Video-success?style=for-the-badge)](https://drive.google.com/file/d/15WUJzGNh76TD76_nb9KsDOhJhG2axrXT/view?usp=sharing)
### Usage
```bash
python main.py
```
